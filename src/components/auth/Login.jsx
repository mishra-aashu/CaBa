...
const Login = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Don't wait for result as OAuth redirects to callback
      if (!result) {
  ...
  return (
    <div className="auth-page">
      ...
      >
        {loading ? (
          <>
            <div style={{ width: '18px', height: '18px', border: '2px solid #ddd', borderTop: '2px solid #666', borderRadius: '50%', animation: 'spin 1s linear infinite' }}></div>
            Connecting...
          </>
        ) : (
          <>
